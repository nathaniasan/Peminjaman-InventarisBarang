...
<head>
  ...
  <!-- DataTables CSS -->
  <link href="<?php echo base_url() ?>assets/backend_assets/vendor/datatables-plugins/dataTables.bootstrap.css"
    rel="stylesheet">

  <!-- DataTables Responsive CSS -->
  <link href="<?php echo base_url() ?>assets/backend_assets/vendor/datatables-responsive/dataTables.responsive.css"
    rel="stylesheet">
...
<body>
  ...
  <div id="wrapper">
    ...
    <!-- Navigation -->
    <nav class="navbar bg-head navbar-static-top" role="navigation" style="margin-bottom: 0;">
      <div class="navbar-header">
        <img class="sipelator-kecil" src="<?= base_url('asset-login/images/login/ikon-sipelator-kecil.svg'); ?>"
          title="poltek" width="40" />
        ...
        <a class="navbar-brand" href="#"><img src="">Selamat Datang,
      ...
      <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
          <ul class="nav" id="side-menu">
            ...
            <li>
              <a href="<?php echo base_url('member_system/profile') ?>"><i class="fa fa-user fa-fw"></i>
                Profil</a>
            </li>
            <li>
            ...
            <li>
              <a href="<?php echo base_url('member_system/barang') ?>"><i class="fa fa-archive fa-fw"></i> Data
                Barang</a>
            </li>
            <li>
              <a href="<?php echo base_url('member_system/pinjam') ?>"><i class="fa fa-book fa-fw"></i> Barang
                Dipinjam</a>
            </li>
            <li>
            ...
            <li>
              <a href="<?php echo base_url('member/do_logout') ?>"><i class="fa fa-sign-out fa-fw"></i> Keluar</a>
            </li>
  ...
  <script
    src="<?php echo base_url() ?>assets/backend_assets/vendor/datatables-plugins/dataTables.bootstrap.min.js"></script>
  <script
    src="<?php echo base_url() ?>assets/backend_assets/vendor/datatables-responsive/dataTables.responsive.js"></script>
